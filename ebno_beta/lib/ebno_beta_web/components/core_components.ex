defmodule EbnoBetaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EbnoBetaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EbnoBetaWeb.Gettext, "errors", msg, opts)
    end
  end
